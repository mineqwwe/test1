...
sudo apt update
sudo apt upgrade -y
sudo apt install wget openssh curl openssl vim unzip clang -y
cd $HOME
mkdir sdk
cd sdk
#d_jdk17
...
./sdkmanager --update
#30/31/33
./sdkmanager --install "platform-tools" "platforms;android-33" "build-tools;33.0.2" "ndk-bundle" "ndk;25.2.9519653"
